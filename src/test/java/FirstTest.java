...
public class FirstTest {
    ...
    public void testSearchResultsCompareText() {
        ...
        waitForElementPresent(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@instance='7']//*[contains(@text,'Java')]"),
                "Cannot find text 'Java' in search results",
                10
        );
        assertElementHasText(
                ...
                "Java",
                "Cannot find expected text in search results",
                5
        );
    }
    @Test
    ...
    private WebElement waitForElementAndSetValue(By by, String value, String error_message, long timeoutInSeconds) {
